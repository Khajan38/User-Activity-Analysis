...
const MeetingModel = () => {
     ...
     return (
          ...
          <section className="model-description">
               <h3>ABOUT</h3> <br></br>
               <p>
                    This meeting classifier is built using a custom implementation of the <strong>Multinomial Naive Bayes</strong> algorithm. 
                    It has been trained on a labeled email dataset to distinguish between meeting and non-meeting emails. The performance metrics below are calculated using test data and help evaluate model quality.
               </p><br></br>
               <p>
                    Dataset Source: <a href="https://github.com/Khajan38/User-Activity-Analysis/blob/main/dependencies/meetings_dataset.csv" target="_blank" rel="noreferrer">SMS Spam Collection Dataset - UCI</a>
               </p><br></br>
